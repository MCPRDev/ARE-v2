...
# Form implementation generated from reading ui file 'staff_administration_panels.ui'
#
...
class Ui_staff_management_window(object):
    def setupUi(self, staff_management_window):
        ...
        self.tablew_subject_show.horizontalHeader().setVisible(False)
...
if __name__ == "__main__":
    ...
    staff_management_window = QtWidgets.QMainWindow()
    ui = Ui_staff_management_window()
    ui.setupUi(staff_management_window)
    staff_management_window.show()
    sys.exit(app.exec_())
